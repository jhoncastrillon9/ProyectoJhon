...
class Proveedores extends CI_Controller 
{
	...
	public function index()
	{
		...
		$crud->Set_subject('Listado de Proveedores');
		...
		//campos obligatorios
		$crud->required_fields(array('identificacion','razonsocial', 'nombrecomercial','direccion',  'correo'));
		//campso a mostratr nuevo
		$crud->fields(array('identificacion','razonsocial','nombrecomercial', 'direccion','telefono','correo',
			'nombrerepresentante','cedularrepresentate','copiarut' ));
		$crud->columns(array('identificacion','razonsocial', 'telefono','correo', 'nombrerepresentante'));
